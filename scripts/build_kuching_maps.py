    ...
    if not args.heritage:
        specs = [
            ...
            OSMSpec(
                ...
                bbox=(1.5680, 1.5835, 110.2640, 110.2845),
                landmarks={
                    ...
                    "Swan Commercial Centre": (1.57480, 110.28250),
                    "Akademi Kastam Diraja": (1.57720, 110.27910),
                    "Matang Hospital": (1.57840, 110.27510),
                    "Taman Palma Matang": (1.57560, 110.27780),
                },
                origin_name="Kubah National Park Entrance",
                destination_names=["Swan Commercial Centre", "Matang Hospital"],
                connections=[
                    ...
                    ("E-Mart Matang", "Swan Commercial Centre"),
                    ("Swan Commercial Centre", "E-Mart Matang"),
                    ("Swan Commercial Centre", "Akademi Kastam Diraja"),
                    ("Akademi Kastam Diraja", "Swan Commercial Centre"),
                    ("Akademi Kastam Diraja", "Matang Hospital"),
                    ("Matang Hospital", "Akademi Kastam Diraja"),
