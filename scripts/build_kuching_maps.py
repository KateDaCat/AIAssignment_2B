        ...
        specs = [
            ...
            OSMSpec(
                ...
                connections=[
                    ...
                    ("Sarawak Forestry Corporation", "Kolej Vokasional Kuching"),
                    ("Kolej Vokasional Kuching", "Sarawak Forestry Corporation"),
                    ("Kolej Vokasional Kuching", "Kuching-Serian Flyover"),
                    ("Kuching-Serian Flyover", "Kolej Vokasional Kuching"),
                ],
                accident_connection=("Sarawak Forestry Corporation", "Kolej Vokasional Kuching"),
                accident_severity="Severe",
                accident_multiplier=1.8,
                zoom=15,
            ),
