    ...
    if not args.heritage:
        specs = [
            ...
            OSMSpec(
                ...
                bbox=(1.4820, 1.4935, 110.3420, 110.3490),
                landmarks={
                    "Kuching International Airport": (1.48450, 110.34750),
                    "Airport Roundabout": (1.48660, 110.34600),
                    "Airport Junction": (1.48840, 110.34550),
                    "Premier Food Court": (1.48950, 110.34450),
                    "Simpang Tiga Roundabout": (1.49200, 110.34310),
                    "Jalan Tun Jugah Overpass": (1.49040, 110.34660),
                    "KIA Fire Station": (1.48390, 110.34810),
                },
                origin_name="Kuching International Airport",
                destination_names=["Simpang Tiga Roundabout", "Premier Food Court"],
                connections=[
                    ("Kuching International Airport", "Airport Roundabout"),
                    ("Airport Roundabout", "Kuching International Airport"),
                    ("Airport Roundabout", "Airport Junction"),
                    ("Airport Junction", "Airport Roundabout"),
                    ...
                    ("Airport Junction", "Jalan Tun Jugah Overpass"),
                    ("Jalan Tun Jugah Overpass", "Airport Junction"),
                    ("Jalan Tun Jugah Overpass", "Simpang Tiga Roundabout"),
                    ("Simpang Tiga Roundabout", "Jalan Tun Jugah Overpass"),
                    ("Kuching International Airport", "KIA Fire Station"),
                    ("KIA Fire Station", "Kuching International Airport"),
                ],
